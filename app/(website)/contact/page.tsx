...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <HeroSection badgeText= "Get in Touch"
  title="Let's Build Your Dream Together"
  description= "Ready to transform your startup vision into reality? Connect with our team of experts and discover how dreamsStartup can accelerate your journey to success." />
