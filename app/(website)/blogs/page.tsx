...
export default function BlogsPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      <HeroSection
        badgeText="Insights & Updates"
        title="Stay Ahead with Startup Intelligence"
        description="Explore the latest trends, strategies, and insights in entrepreneurship, technology, and digital transformation to fuel your startup's growth and innovation."
      />
