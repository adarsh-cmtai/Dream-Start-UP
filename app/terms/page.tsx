        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <Alert>
              ...
              <AlertDescription>
                <strong>Important:</strong> By accessing or using our platform, you agree to be bound by these Terms of
            ...
            <Card id="acceptance">
              ...
              <CardContent className="space-y-4">
                <p className="text-muted-foreground">
                  These Terms of Service ("Terms") constitute a legally binding agreement between you and Training
                  Platform Inc. ("Company," "we," "us," or "our") regarding your use of our website, platform, and
                ...
                <div className="bg-accent/10 p-4 rounded-lg">
                  <p className="text-sm font-medium">
                    You must be at least 18 years old to use our services. If you are under 18, you may only use our
                    services with the involvement and consent of a parent or guardian.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card id="services">
              ...
              <CardContent className="space-y-6">
                <p className="text-muted-foreground">
                  We provide an online learning platform that offers professional training courses, educational content,
                  and related services designed to help individuals advance their careers.
                </p>
                ...
                <div className="bg-orange-50 border border-orange-200 p-4 rounded-lg">
                  <p className="text-sm text-orange-800">
                    <strong>Service Availability:</strong> We strive to maintain 99.9% uptime, but we do not guarantee
                    uninterrupted access to our services. We may temporarily suspend services for maintenance, updates,
                    or technical issues.
                  </p>
                </div>
              </CardContent>
            ...
            <Card id="payment-terms">
              ...
              <CardContent className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-3">Course Fees and Subscriptions</h3>
                  <ul className="list-disc list-inside space-y-2 text-muted-foreground">
                    <li>Course prices are displayed in USD and may vary by region</li>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    You are responsible for any applicable taxes, duties, or government fees related to your use of our
                    services. Prices displayed may not include applicable taxes.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card id="user-conduct">
              <CardHeader>
                <CardTitle className="text-2xl">User Conduct and Prohibited Activities</CardTitle>
              </CardHeader>
              <CardContent className="space-y-6">
                <p className="text-muted-foreground">
                  You agree to use our services responsibly and in compliance with all applicable laws. The following
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold mb-3 text-red-600">Prohibited Activities</h3>
                    <ul className="list-disc list-inside space-y-1 text-muted-foreground text-sm">
                ...
                <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
                  <p className="text-sm text-red-800">
                    <strong>Enforcement:</strong> Violation of these terms may result in immediate account suspension or
                    termination, removal of content, and potential legal action.
                  </p>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    All content on our platform, including courses, videos, text, graphics, logos, and software, is
                    owned by us or our licensors and is protected by copyright, trademark, and other intellectual
                    property laws.
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground text-sm">
                    <li>You may access content only for personal, non-commercial use</li>
                    <li>You may not download, copy, or distribute our content</li>
                    <li>You may not create derivative works from our content</li>
                    <li>Screenshots and recordings are prohibited without permission</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground mb-3">
                    You retain ownership of content you create and submit to our platform (such as forum posts,
                    comments, or assignments). However, you grant us certain rights:
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground text-sm">
                    <li>Non-exclusive license to use, display, and distribute your content</li>
                    <li>Right to moderate, edit, or remove inappropriate content</li>
                    <li>Permission to use your content for platform improvement</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    ...
                    copyright@trainingplatform.com with detailed information about the alleged infringement.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="bg-yellow-50 border border-yellow-200 p-4 rounded-lg">
                  <p className="text-sm text-yellow-800 font-medium mb-2">IMPORTANT DISCLAIMER:</p>
                  <p className="text-sm text-yellow-800">
                    Our services are provided "as is" without warranties of any kind. We do not guarantee that our
                    courses will result in job placement, salary increases, or career advancement.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground text-sm">
                    ...
                    <li>Course content may become outdated due to industry changes</li>
                    <li>Individual results may vary based on effort and circumstances</li>
                    <li>We are not responsible for third-party content or links</li>
                  </ul>
                </div>

                <div>
                  <h3 className="text-lg font-semibold mb-3">Educational Disclaimers</h3>
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground text-sm">
                    <li>Our courses are for educational purposes only</li>
                    <li>We do not provide professional advice or certifications</li>
                    <li>Students are responsible for verifying information accuracy</li>
                    <li>Completion does not guarantee professional competency</li>
                  </ul>
                </div>
              </CardContent>
            </Card>
            ...
            <Card id="limitation-liability">
              ...
              <CardContent className="space-y-4">
                <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
                  <p className="text-sm text-red-800 font-medium mb-2">LIABILITY LIMITATION:</p>
                  <p className="text-sm text-red-800">
                    To the maximum extent permitted by law, our total liability to you for any claims arising from these
                    terms or your use of our services shall not exceed the amount you paid us in the 12 months preceding
                    the claim.
                  </p>
                </div>

                <div>
                  <h3 className="text-lg font-semibold mb-3">Excluded Damages</h3>
                  <p className="text-muted-foreground mb-2">
                    We shall not be liable for any indirect, incidental, special, or consequential damages, including:
                  </p>
                  <ul className="list-disc list-inside space-y-1 text-muted-foreground text-sm">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    You agree that any arbitration or legal proceeding shall be conducted on an individual basis only
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    We may modify these Terms at any time by posting updated terms on our website. Continued use of our
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    For questions about these Terms, please contact us at legal@trainingplatform.com or +1 (555)
                    123-4567.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6 bg-primary/5 border-primary/20">
                ...
                <p className="text-muted-foreground text-sm">
                  ...
                  Terms of Service. If you do not agree to these terms, please discontinue use of our platform
                  immediately.
                </p>
              </CardContent>
            </Card>
